  ...
  return (
    ...
    <div className="font-inter leading-relaxed space-y-6 text-justify max-w-4xl">
        <div>
          ...
          <p className="text-sm text-gray-600">{t("education.studies.0.institution")}</p>
        ...
        <div>
          ...
          <p className="text-sm text-gray-600">{t("education.studies.1.institution")}</p>
          <div className="text-gray-700 font-inter leading-relaxed space-y-6 text-justify max-w-4xl">
        ...
        <div>
          ...
          <p className="text-sm text-gray-600">{t("education.studies.2.institution")}</p>
          <div className="text-gray-700 font-inter leading-relaxed space-y-6 text-justify max-w-4xl">
